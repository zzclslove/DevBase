 ...
 */
public class SpecWarpLinearLayout extends ViewGroup {

    private Type mType;
    private List<WarpLine> mWarpLineGroup;

    public SpecWarpLinearLayout(Context context) {
        this(context, null);
    }

    public SpecWarpLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.WarpLinearLayoutDefault);
    }

    public SpecWarpLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
